...
$cacheFilePath	= dirname(__FILE__) . '/charImageStudy.cache';
$charImgFeaStudy	= new CharImageFeatureStudy();
if (is_file($cacheFilePath)) {
	$charImgFeaStudy->loadCache($cacheFilePath);
} else {
	studySamples($singleDir, $charImgFeaStudy);
	$charImgFeaStudy->saveCache($cacheFilePath);
}
...
function studySamples($sampleDir, $charImgFeaStudy)
{
	$singleDirRes	= opendir($sampleDir);
